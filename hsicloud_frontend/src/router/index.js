    ...
    children: [
      {
        ...
        name: 'Dashboard',
        meta: { title: 'Parallel CBIR system for HSIs', icon: 'dashboard', affix: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        meta: { title: 'HSIs Repository', icon: 'list' }
      },
      {
        path: 'List Details',
      ...
      },
      {
        ...
        name: 'Unmixing',
        meta: { title: 'Unmixing', icon: 'guide' },
        hidden: true
      },
      {
        path: 'Upload',
        ...
        name: 'Upload',
        meta: { title: 'Upload HSIs', icon: 'guide' }
      },
    ]
    ...
    children: [
      {
        ...
        meta: { title: 'Spectral Library', icon: 'tree-table' }
      },
    ]
  },
