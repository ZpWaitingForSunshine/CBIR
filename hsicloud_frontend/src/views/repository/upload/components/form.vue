      ...
      form: [
        {
          ...
          name: 'samples', type: 'input', inputType: 'number', disabled: false, inputLabel: 'samples', modelName: 'userName', placeholder: '', required: true, defaultValue: null
        }, {
          name: 'rows', type: 'input', inputType: 'number', disabled: false, inputLabel: 'rows', modelName: 'userName', placeholder: '', required: true, defaultValue: null
        }, {
          name: 'bands', type: 'input', inputType: 'number', disabled: false, inputLabel: 'bands', modelName: 'userName', placeholder: '', required: true, defaultValue: null
        }, {
          name: 'headeroffset', type: 'input', inputType: 'number', disabled: false, inputLabel: 'headeroffset', modelName: 'userName', placeholder: '', required: true, defaultValue: null
        }, {
          ...
          name: 'blocknumber', type: 'input', inputType: 'string', disabled: false, inputLabel: 'blocknumber', modelName: 'userName', placeholder: '', required: true, defaultValue: null
        }
      ]
    }
  },
