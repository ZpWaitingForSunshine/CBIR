    ...
    <div v-show="orderStatus == 2" class="tabs">
      <el-row >
        <div v-for="(value, key) in final" v-show="value != null" :key="key">
          ...
          <el-col :span="9"><div class="grid-content bg-purple-light"><h5>{{ value }}</h5></div></el-col>
        </div>
        <el-col :span="3"><div class="grid-content bg-purple property-title"><h5>Thumbnail:</h5></div></el-col>
        <el-col :span="9"><img :src="final.thumbnailurl"></el-col><br><br><br>
        <el-col :span="3"><div class="grid-content bg-purple property-title"><h5>Action:</h5></div></el-col>
        <el-col :span="9"><el-button type="primary" @click="goUnmixing">Go Unmixing</el-button></el-col>
